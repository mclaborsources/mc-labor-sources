...
const ASSIGNMENT_JOB_SITE_SELECT =
  'id, name, address, city, customer_id, foreman_name, foreman_phone, foreman_email, foremen:job_site_contacts(slot_number, name, email, cell, office_phone), customer:customers(id, company_name)';
