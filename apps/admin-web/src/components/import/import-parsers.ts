  ...
  return rows
    .map((row) => {
      ...
      return {
        ...
        phone: optionalField(findExactColumnValue(row, ['EmMobilePhone', 'Mobile Phone', 'Cell', 'Phone', 'Mobile'])),
        home_phone: optionalField(findExactColumnValue(row, ['EmHomePhone', 'Home Phone'])),
        address: optionalField(findExactColumnValue(row, ['EmAddress', 'Employee Address', 'Address'])),
        position: optionalField(findExactColumnValue(row, ['Trade', 'Position', 'Trade Position', 'Job Title'])),
