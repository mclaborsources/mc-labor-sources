-- Use the client-approved short confirmation code for week-scoped test data deletion.
...
BEGIN
  ...
  RETURN jsonb_build_object(
    'cleared', true, 'weekStart', v_week_start, 'weekEnd', p_week_end,
    'counts', jsonb_build_object(
      'attendanceLogs', v_attendance, 'timesheets', v_timesheets,
      'assignments', v_assignments, 'importRuns', v_import_runs
    )
  );
END;
$$;
